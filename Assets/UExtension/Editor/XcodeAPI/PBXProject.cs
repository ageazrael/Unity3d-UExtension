...
using System.IO;
using UExtension.XcodeAPI.PBX;

namespace UExtension.XcodeAPI
{
    ...
    public class PBXProject
    {
        ...
        public void AddFrameworkToProject(string targetGuid, string frameworkPath, string framework, bool weak)
        {
            string fileGuid = AddFile(PBXPath.Combine(frameworkPath, framework), "Frameworks/" + framework, PBXSourceTree.Sdk);
            AddBuildFileImpl(targetGuid, fileGuid, weak, null);
        }
        public void AddFrameworkToProjectByFileGuid(string targetGuid, string fileGuid, bool weak)
        {
			AddBuildFileImpl(targetGuid, fileGuid, weak, null);
        }
